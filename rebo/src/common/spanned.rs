...
impl SpanWithId {
    ...
    pub fn new_with_span_id_unsafe(id: SpanId, file: FileId, start: usize, end: usize) -> SpanWithId {
        SpanWithId { id, span: Span::new(file, start, end) }
    }
...
impl PartialEq for SpanWithId {
    fn eq(&self, other: &Self) -> bool {
        self.id.eq(&other.id)
    }
}
impl Eq for SpanWithId {}
impl PartialOrd for SpanWithId {
    fn partial_cmp(&self, other: &Self) -> Option<std::cmp::Ordering> {
        self.id.partial_cmp(&other.id)
    }
}
impl Ord for SpanWithId {
    fn cmp(&self, other: &Self) -> std::cmp::Ordering {
        self.id.cmp(&other.id)
    }
}
impl Hash for SpanWithId {
